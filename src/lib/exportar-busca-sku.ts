...
export function criarExcelBuscaSku(dataBusca: string, itens: ItemExportacaoSku[]) {
  const linhaData = `<row r="1"><c r="A1" t="inlineStr"><is><t>Data da busca</t></is></c><c r="B1" t="inlineStr"><is><t>${escaparXml(dataBusca)}</t></is></c></row>`;
  const cabecalho = '<row r="3"><c r="A3" t="inlineStr"><is><t>SKU</t></is></c><c r="B3" t="inlineStr"><is><t>TITULO_PRODUTO</t></is></c><c r="C3" t="inlineStr"><is><t>QTD</t></is></c></row>';
