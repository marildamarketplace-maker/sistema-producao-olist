                ...
                {extrairDivisoesPreview(item.infoAdicional).map((divisao, divisaoIndex) => (
                  <div key={divisaoIndex} className="mt-4 rounded-md border border-slate-200 bg-slate-50 p-3">
                    ...
                    <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                      ...
                      <label className="text-sm text-slate-700">Corte a laser<select disabled value={divisao.laser} className="mt-1 w-full rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-slate-500"><option value="false">Não</option><option value="true">Sim</option></select></label>
                    </div>
                  </div>
                ))}
