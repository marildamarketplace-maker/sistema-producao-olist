...
type Vendedor = { id?: number; contato?: Contato | null; situacao?: "B" | "A" | "I" | "E" | null; usuarioVinculado?: { id: string; nome: string; email: string; ativo: boolean } | null };
...
function VendedoresOlistPage() {
  ...
  const [vendedoresValidados, setVendedoresValidados] = useState<Record<string, boolean>>({});
